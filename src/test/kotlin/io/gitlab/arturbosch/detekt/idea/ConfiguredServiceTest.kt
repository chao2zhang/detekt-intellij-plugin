    ...
    fun `expect detekt runs successfully`() {
        ...
        assertThatCode {
            ...
            .hasMessage("org.jetbrains.kotlin.cli.jvm.compiler.KotlinCoreEnvironment\$Companion.createForProduction(" +
                "Lorg/jetbrains/kotlin/com/intellij/openapi/Disposable;" +
                "Lorg/jetbrains/kotlin/config/CompilerConfiguration;" +
                "Lorg/jetbrains/kotlin/cli/jvm/compiler/EnvironmentConfigFiles;" +
